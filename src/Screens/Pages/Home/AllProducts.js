...
import { FetchCategories, FetchColors } from "../../../redux/Features/Product";
          ...
          >
            <TouchableWithoutFeedback onPress={stopPropagation}>
              ...
              >
                ...
                <ScrollView className="px-3 my-4">
                  <View>
                  ...
                  <View>
                    ...
                    <View className="flex flex-row flex-wrap gap-1 px-2">
              ...
              <View
                className={`${
                  gridDisplay
                    ...
                    : "w-[30%] h-32 rounded-md bg-white relative"
                }`}
              >
                <Image
